...
![Captura de tela do Figma da Code Trouble demonstrando os templates](./images/image-01.png)
...
![Captura de tela do Figma da Code Trouble demonstrando o resultado final](./images/image-02.png)
...
![Componente Header, organismo](./images/image-03.png)
...
![Moléculas do componente Header](./images/image-04.png)
...
![Átomos do componente Header](./images/image-05.png)
...
![Componente toggleButton, átomo](./images/image-06.png)
...
![Componente pageControl, átomo](./images/image-07.png)
...
![Componente textInput, molécula](./images/image-08.png)
...
![Componente cookies, organismo](./images/image-09.png)
...
![Propriedades do componente Tags](./images/image-10.png)
...
![Estados de interação do componente Tags](./images/image-11.png)
...
![Logo Code Trouble, completo e preto](./images/image-12.png)
...
![Logo Code Trouble, completo e verde](./images/image-13.png)

*Logo Code Trouble, completo e verde.*

![Logo Code Trouble, completo e laranja](./images/image-14.png)

*Logo Code Trouble, completo e laranja.*

![Logo Code Trouble, completo e azul](./images/image-15.png)
...
![Logo compacta preta](./images/image-16.png)

*Logo compacta preta.*

![Logo compacta azul](./images/image-17.png)

*Logo compacta azul.*

![Logo compacta verde](./images/image-18.png)

*Logo compacta verde.*

![Logo compacta laranja](./images/image-19.png)
...
![Paleta de cores da Code Trouble](./images/image-20.png)
...
![Paleta de cinzas da Code Trouble](./images/image-21.png)
...
![Paleta de gradientes Dark Pastel Green](./images/image-22.png)

*Paleta de gradientes: Dark Pastel Green.*

![Paleta de gradientes Channel Orange](./images/image-23.png)

*Paleta de gradientes: Channel Orange.*

![Paleta de gradientes Violet Blue](./images/image-24.png)
...
![Vermelho principal, para o fundo e para destaque](./images/image-25.png)
...
![Azul principal, para o fundo e para destaque](./images/image-26.png)
...
![Verde principal, para o fundo e para destaque](./images/image-27.png)
...
![Amarelo principal, para o fundo e para destaque](./images/image-28.png)
...
![Demonstração da fonte Montserrat](./images/image-29.png)

*Títulos — Montserrat.*

![Demonstração da fonte Lora Italic](./images/image-30.png)

*Subtítulos — Lora Italic.*

![Demonstração da fonte Hind](./images/image-31.png)
...
![Ícones pixelizados da comunidade do Figma](./images/image-32.png)
...
![Guia de estilo da Code Trouble](./images/image-33.png)
