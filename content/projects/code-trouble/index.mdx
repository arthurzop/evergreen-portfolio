...
A construção das interfaces foi baseada em uma abordagem de [Atomic Design](/writing/atomic-design-code-trouble), permitindo transformar os elementos recorrentes da plataforma em uma estrutura de componentes reutilizáveis. A partir de elementos básicos de interface, foram desenvolvidos componentes compostos e estruturas maiores utilizadas ao longo das diferentes páginas.
...
> Escrevi um ensaio mais aprofundado sobre como apliquei essa metodologia especificamente nesse projeto, do átomo até a página final — ["Organização e Escalabilidade para Aplicações Digitais"](/writing/atomic-design-code-trouble).
