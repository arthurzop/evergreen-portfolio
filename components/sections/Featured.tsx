...
export function Featured() {
  ...
  return (
    <Section
      id="featured"
      className="flex flex-col justify-center px-64 gap-8 font-geist"
    >
      <div className="font-bricolage">
        <h2 className="text-6xl font-bold">the thirteen</h2>
      ...
      >
        ...
        <div className="flex flex-col gap-6 h-full justify-between">
          <div>
            <h3 className="font-semibold mb-2 text-3xl">about the project</h3>
            <p className="text-gs-700 leading-relaxed">
              the thirteen is a personal archive built around the idea that good
              references deserve more than a bookmark. It brings together visual
              identities, interfaces, typography, editorial work and other
              references into a structured system designed for exploration and
              continuous curation. <br /> <br />
              the project explores how a personal collection can become a useful
              design tool, turning scattered references into an organized visual
              language that can be revisited, expanded and connected over time.
            </p>
          </div>
